    ...
    <div class="contentContainer">
        ...
        <div class="table-parent">
            ...
            <thead >
              ...
              <tr>
                <td class="table-data" >International</td>
                <td class="table-data" >National</td>
              </tr>
            </thead>
            <tbody >
              <tr>
              ...
              <tr>
                <td  class="table-data">Dr Ashok Bhansali</td>
                <td  class="table-data">Associate professor</td>
