...
$CURRENTDIRURL = $ROOTURL . "departments/oral-medicine-and-radiology/gallery/";
    ...
    <div class="contentContainer">
        <div>
            <div class="galleryCardContainer">
                ...
                <div class="galleryCard">
                    <img src="<?php echo $CURRENTDIRURL ?>assets/radiology.jpeg" alt="Department Image" loading="lazy" />
                    <p>
                        Service
                    </p>
                </div>
        ...
        <div>
            ...
            <div class="galleryCardContainer">
                ...
                <div class="galleryCard">
                    <img src="<?php echo $CURRENTDIRURL ?>assets/CBCT TRAINING2.png" alt="Department Image" />
                    <p>
                    </p>
                </div>
            </div>
