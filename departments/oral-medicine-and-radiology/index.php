    ...
    <div class="contentContainer">
        ...
        <div class="largeContentCard">
            ...
            <ul>
                ...
                <li>
                    To offer cutting-edge professional education and training to students, ranging from foundational to advanced levels, integrating innovative approaches to teaching and learning.
                </li>
                <li>
                    Cultivating research endeavors aimed at delivering evidence-based diagnoses and treatment strategies.
                </li>
            </ul>
        </div>
        ...
        <div class="largeContentCard">
            ...
            <li>
                Diagnostic assessment of common dental conditions by history and clinical examination of the patients attending the OPD.Investigations of the patients if warranted and medicinal treatment if required.
            </li>
            <li>
                Provision of screening and counselling services for tobacco and betel-nut addiction cessation, supported by a dedicated tobacco cessation centre.
            </li>
            <li>
                Screening and diagnosis of head and neck malignancies.
            </li>
            <li>
                Management of complications arising from chemotherapy and radiotherapy.
            </li>
            <li>
                Identification and management of diverse oral mucosal conditions, potentially malignant disorders, salivary gland disorders, autoimmune diseases, and pigmented lesions of the oral mucosa.
            </li>
            <li>
                Treatment of TemporomandibularJoint disorders and various Orofacial pain syndromes.
            </li>
            <li>
        ...
        <div class="facultyContainer">
            ...
            <div class="facultyGallery">
                <div class="facultyCard">
                    <img src="<?php echo $CURRENTDIRURL ?>assets/dr-jaishri-pagare/photo.JPG" alt="faculty" width="200" height="200" />
                ...
                <div class="facultyCard">
                    <img src="<?php echo $CURRENTDIRURL ?>assets/dr-vikrant-kasat/photo.JPG" alt="faculty" width="200" height="200" />
                ...
                <div class="facultyCard">
                    <img src="<?php echo $CURRENTDIRURL ?>assets/dr-ankita-goklani/photo.JPG" alt="faculty" width="200" height="200" />
                ...
                <div class="facultyCard">
                    <img src="<?php echo $CURRENTDIRURL ?>assets/dr-om-kharat/photo.JPG" alt="faculty" width="200" height="200" />
                ...
                <div class="facultyCard">
                    <img src="<?php echo $CURRENTDIRURL ?>assets/dr-archana-dama/photo.JPG" alt="faculty" width="200" height="200" />
        ...
        <div>
            ...
            <div class="galleryCardContainer">
                ...
                <div class="galleryCard">
                    <img src="<?php echo $CURRENTDIRURL ?>gallery/assets/Teaching Staff.png" alt="Department Image" /> 
                    <p>Teaching Staff</p>
                </div>
                <div class="galleryCard">
                    <img src="<?php echo $CURRENTDIRURL ?>gallery/assets/Postgraduate Students.png" alt="Department Image" /> 
                    <p>Postgraduate Students</p>
                </div>
                <div class="galleryCard">
                    <img src="<?php echo $CURRENTDIRURL ?>gallery/assets/TOBACCO DE-ADDICTION THERAPIES1.png" alt="Department Image" /> 
                    <p></p>
                </div>
